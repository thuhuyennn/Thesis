    ...
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-green-600 dark:bg-gray-800 border-none">
          ...
          <span class="hidden md:block"><?php echo $_SESSION['user'] ; ?> (ID: <?php echo $_SESSION['id_user'] ; ?>)</span>
        </div>
      ...
      <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-green-500 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          ...
          <p class="mb-14 px-5 py-3 hidden md:block text-center text-xs">huyen.nguyen123@hcmut.edu.vn</p>
        </div>
      </div>
      <!-- ./Sidebar -->
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          <div class="bg-green-400 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-500 dark:border-gray-600 text-white font-medium group">
            ...
            <img class="rounded-full h-10 w-10 absolute right-3 bottom-2" src="./assets/img/tim.jpg" alt="">
            </div>
            <div class="text-right">
              <p class="text-2xl" id="data_hr_avg"></p>
              <p>HearRate AVG</p>
            </div>
          </div>
          <div class="bg-green-400 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-500 dark:border-gray-600 text-white font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
            <img class="h-12 w-12 rounded-full  absolute " src="./assets/img/spo2.png" alt="">
            </div>
            <div class="text-right">
              <p class="text-2xl" id="data_sp_avg"></p>
              <p>SPO2 AVG</p>
            </div>
          </div>
          <div class="bg-green-400 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-green-500 dark:border-gray-600 text-white font-medium group">
        ...
        <div class="grid lg:grid-cols-4 gap-4 p-4">
          ...
          <!-- Social Traffic -->
          <div class="relative lg:col-span-3 min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full h-full shadow-lg rounded">
                    ...
                    <div class="flex-grow flex items-center border-b border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                      <div class="flex-grow flex justify-between items-center">
                        <div class="self-center">
                          <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Bác sĩ</a> vừa gửi tin nhắn mới cho bạn
                        </div>
              ...
              <table class="w-full ">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <th class="px-10 py-3">Heartrate</th>
                    <th class="px-10 py-3">SPO2</th>
