...
<div class="min-h-screen flex flex-col items-center justify-center bg-green-100">
  <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
    ...
    <button class="relative mt-6 border rounded-md py-2 text-sm text-gray-800 bg-gray-100 hover:bg-gray-200">
      <span class="absolute left-0 top-0 flex items-center justify-center h-full w-10 text-green-500"><i class="fab fa-facebook-f"></i></span>
      ...
      <form action="login.php" method="POST">
        <div class="flex flex-col mb-6">
          ...
          <div class="relative">
            ...
            <input id="username" type="text" name="username" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="User Name" />
          </div>
        </div>
        <div class="flex flex-col mb-6">
    ...
    <div class="flex justify-center items-center mt-6">
      <a href="register_index.php" target="_blank" class="inline-flex items-center font-bold text-green-500 hover:text-green-700 text-xs text-center">
        <span>
          <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
